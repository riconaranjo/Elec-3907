...
const long sensor_delay = 10;       // in milliseonds [delay between sensors, avoids interference] = 60 / [# ofsensors]
const long conversion_factor = 58;  // converts to centimetres
const int sample_size = 5;         // how many values are averaged per cycle
